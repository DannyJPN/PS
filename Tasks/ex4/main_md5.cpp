...
int main( int num_arg, char **args )
{
	...
	for(passlength=1;passlength <= maxpasslen;passlength++)
	{	char filename[64];
		...
		fclose(outfile);
		unsigned long long totalcount = (unsigned long long)(pow(strlen(charset),passlength));
